...
DEFINE('CONTACT_EMAIL', 'miraj0072004@gmail.com');
...
define ('BASE_URI', 'M:/SoftwareInstallations/Xampp/htdocs/DinnerIt/');
define ('BASE_URL', 'http://localhost/DinnerIt/htdocs/');
define ('MYSQL', BASE_URI . 'mysql_connect.php');
